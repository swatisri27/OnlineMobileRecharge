...
<script type="text/javascript">
	...
	function Validate() {
		...
		if ((nam == null || nam == "") || (dnam == null || dnam == "")
				|| (no == null || no == "") || (pass == null || pass == "")
				|| (cpass == null || cpass == "")) {
...
<body>
  ...
  <a href="#default" class="logo">MOBILE RECHARGE</a>
		...
		<div id="form">
			<form action="registerlogin.jsp" method="post" name="register"
				onsubmit="return Validate();">

				<center>
					<a><h3>
							Please fill in your details. <i>Fields marked with * are
								compulsory.</i>
						</h3></a> <br> <b><br>
					<table height="240">
							<tr>
