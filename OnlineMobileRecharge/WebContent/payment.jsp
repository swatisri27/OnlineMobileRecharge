  ...
  <a href="#default" class="logo">MOBILE RECHARGE</a>
		...
		<%
			...
			try {
				...
				PreparedStatement ps1 = con.prepareStatement("insert into transactiondetail values ('" + tid + "','"
						+ bank + "','" + card_type + "','" + accno + "','" + pin + "','" + user + "')");
				ps1.executeUpdate();

				out.println(
						"<div id=\"about_text\"><center><b><h2>Your transaction is complete</h2></b></center></div>");
				out.println("<div id=\"about_text\"><center><b><h2>Your transaction ID is " + tid
						+ "</h2></b></center></div>");
			}
