...
<body>
  ...
  <a href="#default" class="logo">MOBILE RECHARGE</a>
		...
		<div id=about_text>
			<a><br>
			<br>
			<center>MobileRecharge is a website aims at providing ultimate recharge 
			        solutions to all prepaid mobile
					users. We provide facilities of paying via credit cards, debit
					cards or Net banking. Please feel free to contact us for any
					assistance or complaints!</center></a>
		</div>
