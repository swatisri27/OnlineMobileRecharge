  ...
  <a href="#default" class="logo">MOBILE RECHARGE</a>
		...
		<%
			...
			try {
				...
				int flag = 0;
				while (rs.next()) {
					if (rs.getString("phoneno").compareTo(contact) == 0
							|| rs.getString("emailid").compareTo(emailid) == 0)
						flag = 1;
				}
				if (flag == 0) {
					PreparedStatement ps = con.prepareStatement(
							"insert into subscribe values(\"" + name + "\",\"" + emailid + "\",\"" + contact + "\")");
					ps.executeUpdate();
					System.out.println("subscribed!!");
					out.println(
							"<div id=\"about_text\"><b><br/><br/><h1><center><i>Thank you for subscribing us. You will now receive all our updates via SMS/E-mails.</i></center></h1></b></div>");
				} else {
					System.out.println("not updated!!");
					out.println(
							"<div id=\"about_text\"><b><br/><br/><h1><center><i>You are already subscribed.</i></center></h1></b></div>");
				}
